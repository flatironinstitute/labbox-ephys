...
```bash
labbox-launcher run magland/labbox-ephys:0.1.9-alpha.6 --kachery $KACHERY_STORAGE_DIR --docker_run_opts "--net host" --data $LABBOX_EPHYS_DATA_DIR
```
...
* 0.1.9 [in progress]
    ...
    - Run multiple hither api calls in parallel #8 [in progress]
* 0.1.10
