...
const AverageWaveform_rv: FunctionComponent<Props> = ({boxSize, plotData, argsObject = {id: 0}, title}) => {
    ...
    return (
        <div className="App" style={{width: boxSize.width, height: boxSize.height, display:"flex", padding: 10}}
