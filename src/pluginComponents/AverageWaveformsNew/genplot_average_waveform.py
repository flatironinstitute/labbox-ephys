...
@hi.function('createjob_fetch_average_waveform_new_plot_data', '0.1.0')
def createjob_fetch_average_waveform_new_plot_data(labbox, recording_object, sorting_object, unit_id):
    ...
    with hi.Config(
        ...
        return fetch_average_waveform_new_plot_data.run(
            snippets_h5=snippets_h5,
            unit_id=unit_id
        )

@hi.function('fetch_average_waveform_new_plot_data', '0.2.5')
@hi.container('docker://magland/labbox-ephys-processing:0.3.19')
@hi.local_modules(['../../../python/labbox_ephys'])
def fetch_average_waveform_new_plot_data(snippets_h5, unit_id):
    import h5py
