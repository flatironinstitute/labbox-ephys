...
class EventStream {
    ...
    async readEvents() {
        ...
        const url = `${this._serverUrl}/readEvents/${this._streamId}/${this._position}?channel=${this._channel}&signature=${signature}`;
    ...
    async writeEvents(events) {
        ...
        const url = `${this._serverUrl}/writeEvents/${this._streamId}?channel=${this._channel}&signature=${signature}`;
        const result = await axios.post(url, { events: events });
        if (!result.data.success) {
